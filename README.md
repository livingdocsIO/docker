...
```sh
buildcontainer -t livingdocs/node:22.3 -t livingdocs/node:22 -f node-22.Dockerfile .
buildcontainer -t livingdocs/node:20.7 -t livingdocs/node:20 -f node-20.Dockerfile .
pushcontainer livingdocs/node:22.3 livingdocs/node:22 # skip it when using docker
pushcontainer livingdocs/node:20.7 livingdocs/node:20 # skip it when using docker
```
...
```sh
buildcontainer  -t livingdocs/server-base:22.4 -t livingdocs/server-base:22 -f ./livingdocs-server-base/22.Dockerfile ./livingdocs-server-base
buildcontainer  -t livingdocs/server-base:20.9 -t livingdocs/server-base:20 -f ./livingdocs-server-base/20.Dockerfile ./livingdocs-server-base
pushcontainer livingdocs/server-base:22.4 livingdocs/server-base:22 # skip it when using docker
pushcontainer livingdocs/server-base:20.9 livingdocs/server-base:20 # skip it when using docker
```
...
```sh
buildcontainer  -t livingdocs/editor-base:22.4 -t livingdocs/editor-base:22 -f ./livingdocs-editor-base/22.Dockerfile ./livingdocs-editor-base
buildcontainer  -t livingdocs/editor-base:20.9 -t livingdocs/editor-base:20 -f ./livingdocs-editor-base/20.Dockerfile ./livingdocs-editor-base
pushcontainer livingdocs/editor-base:22.4 livingdocs/editor-base:22 # skip it when using docker
pushcontainer livingdocs/editor-base:20.9 livingdocs/editor-base:20 # skip it when using docker
```
...
regctl image cp docker.elastic.co/elasticsearch/elasticsearch:8.16.2 livingdocs/elasticsearch:8.16.2
```
