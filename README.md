...
buildcontainer  -t livingdocs/server-base:20.13 -t livingdocs/server-base:20 -f ./livingdocs-server-base/20.Dockerfile ./livingdocs-server-base
...
pushcontainer livingdocs/server-base:20.13 livingdocs/server-base:20 # skip it when using docker
```
...
buildcontainer  -t livingdocs/editor-base:20.13 -t livingdocs/editor-base:20 -f ./livingdocs-editor-base/20.Dockerfile ./livingdocs-editor-base
...
pushcontainer livingdocs/editor-base:20.13 livingdocs/editor-base:20 # skip it when using docker
```
